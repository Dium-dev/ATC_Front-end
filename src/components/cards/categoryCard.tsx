...
const CardCategory = ({ name, image, isHovered, handleCardHovering, handleCardLeave }: any) => {
    ...
    return (
        ...
        >
            ...
            <h3 className={`
                z-30 bottom-[5%] left-1/2 text-[clamp(0.5rem,calc(1vw+0.4rem),2.5rem)] ms:text-[clamp(0.5rem,calc(0.25vw+1rem),2.5rem)] xxl:text-[clamp(0.5rem,calc(0.25vw+0.75rem),2.5rem)] font-bold uppercase
