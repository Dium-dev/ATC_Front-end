                        ...
                        <td colSpan={8}>
                            <div className="flex justify-between gap-6 w-full p-6">
                                ...
                                <div className="flex flex-col gap-6 w-1/2">
                                    ...
                                    <button className="w-full px-6 py-[10px] rounded-[10px] bg-secondary-lm text-white text-sm font-bold tracking-wider uppercase animate-drop" style={{ animationDelay: '450ms' }}>
                                        Editar descripción
                                    </button>
                                </div>
                            </div>
