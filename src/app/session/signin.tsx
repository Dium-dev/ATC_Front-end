...
export function SignIn({}) {
  ...
  return (
    <form
      ...
      className="flex items-center justify-centerbg-[rgba(0,0,0,.5)]"
    >
      <div className="relative flex p-6 px-14 pt-10 flex-col bg-white xs:w-[440px] gap-4 rounded-xl shadow-xl w-[440px]">
        ...
        <button
          className="absolute text-secondary-dm text-xs inset-y-0 right-0 flex items-center px-4 cursor-pointer pt-5 mr-14 py-3"
